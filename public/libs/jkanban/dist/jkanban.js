  ...
  this.jKanban = function () {
    ...
    this.addBoards = function (boards, isInit) {
        ...
        for (var boardkey in boards) {
            ...
            '<div class="kanban-title-board" data-boardId="'+board.id+'">'

                + '<div class="d-flex justify-content-end">'
                +'  <a class="editar-board" data-id="'+board.id+'">'
                +'      <i class="far fa-edit"></i>'
                +'  <a/>'
                +'</div>'
                +'<a class="boardTitle">' + board.title + '</a>'
            + '</div>'
            //content board
        ...
        if (self.options.itemHandleOptions.enabled) {
            if ((self.options.itemHandleOptions.customHandler || undefined) === undefined) {
                ...
                */
                ...
                result =  ` <div class="d-flex mb-3">
                                <div class="mr-auto">
                                    <a class="item_handle">
                                        <i class="fas fa-suitcase-rolling item_handle"></i> Mover
                                    <a/>
                                </div>
                                <div class="d-flex justify-content-end">
                                    <a class="editar-item" data-id="${item.id}" data-toggle="modal" data-target="#exampleModal">
                                        <i class="far fa-edit"></i>
                                    <a/>
                                    <a class="ml-2 deletar-item" data-id="${item.id}">
